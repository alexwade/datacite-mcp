export function formatCreator(raw) {
    const result = {
 ...
 */
export function extractPrefixes(record) {
 ...
 */
export function formatClientRecord(record, stats) {
    const a = record.attributes;
    const result = {
        id: record.id,
        name: a.name,
...
export function formatDoiFull(record) {
    const a = record.attributes;
